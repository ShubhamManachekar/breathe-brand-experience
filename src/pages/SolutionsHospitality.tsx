  ...
  return (
    <div className="min-h-screen bg-transparent overflow-hidden">
      ...
      <NeoHero
        ...
        heroImage="https://images.unsplash.com/photo-1542314831-c6a4d27ce66f?w=1920&q=80&auto=format"
        headline={
          <>
            The first thing they notice.
            <br /><span className="block text-gradient-animated">that guests remember.</span></>}
