        ...
        <div className="relative z-10 w-full h-full min-h-[400px] flex items-center justify-center">
           ...
           <div className="relative grid grid-cols-2 gap-4">
              <div className="space-y-4 pt-12">
                 <div className="w-40 h-48 bg-background/60 backdrop-blur-xl rounded-2xl border border-white/20 shadow-neo p-4 rotate-[-6deg] hover:rotate-0 transition-transform duration-500 hover:scale-105 cursor-pointer">
                    <img src={featured[0]?.image} alt="Diffuser" className="w-full h-full object-contain" />
                 </div>
                 <div className="w-32 h-32 bg-background/60 backdrop-blur-xl rounded-2xl border border-white/20 shadow-neo p-3 translate-x-8 hover:scale-105 transition-transform duration-500">
                    <img src={spotlight[0]?.image} alt="Oil" className="w-full h-full object-contain" />
                 </div>
              </div>
              <div className="space-y-4">
                 <div className="w-36 h-36 bg-background/60 backdrop-blur-xl rounded-2xl border border-white/20 shadow-neo p-4 translate-y-8 hover:scale-105 transition-transform duration-500">
                    <img src={spotlight[1]?.image} alt="Oil" className="w-full h-full object-contain" />
                 </div>
                 <div className="w-44 h-56 bg-background/60 backdrop-blur-xl rounded-2xl border border-white/20 shadow-neo p-4 rotate-[4deg] hover:rotate-0 transition-transform duration-500 hover:scale-105 cursor-pointer">
