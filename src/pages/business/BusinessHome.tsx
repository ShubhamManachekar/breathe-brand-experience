...
const BusinessHome = () => {
  ...
  return (
    <div className="overflow-hidden bg-background">
      ...
      {/* ── Neo Hero Section ── */}
      <NeoHero
        heroImage="https://images.unsplash.com/photo-1497366216548-37526070297c?w=1920&q=80&auto=format"
                ...
                {[
                  ...
                  <div key={stat.label} className="bg-background/50 border border-border/40 p-4 hover:border-primary/30 transition-colors duration-300">
                    ...
                    <div className="text-3xl font-display font-semibold text-foreground">
                      <DynamicCounter endValue={stat.value} label={stat.label} duration={2000} />{stat.suffix}
                    </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap justify-center gap-6 sm:gap-8 md:gap-16 opacity-60 grayscale hover:grayscale-0 transition-all duration-500">
            {["Luxe Hotels", "Metro Mall", "ZenWork", "Serenity Clinics", "Apex Towers"].map((name) => (
              <div key={name} className="text-xs sm:text-sm md:text-base font-display font-semibold uppercase tracking-[0.15em] text-muted-foreground">
                {name}
              </div>
            ))}
          </div>
      ...
      <section className="section-shell bg-background relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <AnimatedSection animation="fadeInUp" className="text-center mb-16">
            ...
            <h2 className="font-display text-3xl sm:text-4xl md:text-5xl font-semibold text-foreground mb-4">Tailored for every environment.</h2>
            ...
            {solutions.map((sol, i) => (
              <AnimatedSection key={sol.title} animation="fadeInUp" delay={i * 100}>
                <Link to={sol.to} className="group block h-full">
                  <div className="h-full bg-background border border-border/60 hover:border-primary/40 p-6 sm:p-8 transition-all duration-500 hover:shadow-neo hover:-translate-y-1 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-[0.4fr_1fr] gap-12 items-start">
            <div className="static lg:sticky lg:top-24">
              ...
              <h2 className="font-display text-3xl sm:text-4xl font-semibold text-foreground mb-6">Documented, measurable impact.</h2>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {caseStudies.map((cs, i) => (
                <AnimatedSection key={cs.company} animation="fadeInUp" delay={i * 150}>
                  <div className="bg-background border border-border/50 p-6 sm:p-8 hover:border-primary/30 transition-all duration-300 shadow-sm hover:shadow-md h-full flex flex-col justify-between">
                    <div>
      ...
      <section className="section-shell bg-muted/10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-0 shadow-2xl shadow-primary/5 rounded-sm overflow-hidden border border-border/40">
            {/* Left: Content */}
            <div className="bg-primary text-primary-foreground p-6 sm:p-10 md:p-14 flex flex-col justify-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <h2 className="font-display text-3xl sm:text-4xl font-semibold mb-4">Let's craft your signature atmosphere.</h2>
            ...
            {/* Right: Form */}
            <div className="bg-background p-6 sm:p-10 md:p-14">
              {leadSubmitted ? (
